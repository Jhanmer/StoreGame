		...
		<div class="container-fluid">
			<div class="row main-top-w3l py-2">
				...
				<div class="col-lg-8 header-right mt-lg-0 mt-2">
						...
						<?php
							...
							<a href='#' data-toggle='modal' data-target='#exampleModal2' class='text-white'>
							 ...
							 <?php
                               ...
                               if ($Cargo == "Usuario") {
                                    echo "<li class='text-center border-right text-white' ><a class='text-white' href='./config/Salir.php'>
					...
					<!--	<h2>Bienvenido <?php //echo $user['txtUser']?></h2>-->
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="./controlador/controladorRegistrarUsuario.php" method="post">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" placeholder=" " name="txtApe" required="">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" placeholder=" " name="txtUser" required="">
						</div>
						<div class="form-group">
								...
								<div class="navbar-inner">
									...
									<!-- search -->
									          ...
									          <form class="form-inline" action="#" method="post">
													...
													<br></br>
													<input type="text" class="form-control mr-sm-5" id="txtBus" name="txtBus" placeholder="Buscar..." requirede>
										...
										<div class="container">
											<div class="row">
												<div class="col-md-12">
													...
													$Query = "select p.idProducto,c.nomCate,p.nombrePro,p.foto,p.precioPro from g_producto p INNER JOIN g_categoria c ON
